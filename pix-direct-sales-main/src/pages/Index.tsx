            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              <div className="order-1 md:order-1">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#232323]/80 border border-[#8A2BE2]/30 text-[#CFCFCF] mb-6">
                  ...
                  <span>Fature mais com a GouPay</span>
                </div>
                ...
                <p className="fade-on-scroll text-lg md:text-xl text-[#CFCFCF] mt-6 max-w-xl">
                  Esse sistema é criado para quem quer maximizar lucros, eliminar taxas e acelerar todo o fluxo de vendas. Uma experiência mais rápida, leve e independente para o seu negócio crescer.
                </p>
              ...
              <div className="order-2 md:order-2 relative mobile-hero-container">
                ...
                <img src="https://i.imgur.com/vtcLGj6.png" alt="Visão geral da plataforma" className="fade-on-scroll w-full h-auto rounded-xl shadow-none md:scale-[2.2] lg:scale-[2.6] transform-gpu origin-center mobile-hero-img" loading="lazy" referrerPolicy="no-referrer" />
