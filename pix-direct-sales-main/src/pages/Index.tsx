          ...
          <div className="mx-auto max-w-6xl px-4 relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className="order-2 md:order-2 relative mobile-hero-container">
                ...
                <img src="https://i.imgur.com/Qj89l7i.png" alt="Visão geral da plataforma" className="fade-on-scroll w-full h-auto rounded-xl shadow-none md:scale-[1.2] transform-gpu origin-center mobile-hero-img" loading="lazy" referrerPolicy="no-referrer" />
